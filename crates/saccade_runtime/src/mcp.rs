    ...
    match method {
        ...
        "system.capabilities" => {
            ...
            result["execution_contract"] = json!({
                ...
                "external_execution_when":"saccade.act returns external_execution_required",

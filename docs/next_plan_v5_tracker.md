...
1. N8 Current Tab Co-Pilot productization: local shell and MCP API gates pass;
   next make the selected-tab grant visible in browser UI and bind it to a real
   selected tab.

...
5. Harden browser-backed MCP sessions: shared multi-tab process and DEVMAX/FORMMAX integration with the live tab. Worker report/replay, screenshot policy, and sensitive-value redaction are in place.

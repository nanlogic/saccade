...
3. WebGL/canvas P1: use `scripts/probe_webgl_game_runtime.py` as the live-game red/green gate for `http://127.0.0.1:4173/`, then isolate why the game routes `blocked_missing_gameplay_layer` while `selftest-webgl-runtime` is green.

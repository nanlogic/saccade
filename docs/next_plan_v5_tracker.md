...
3. WebGL/canvas P1: add live-game runtime/pixel probe for `http://127.0.0.1:4173/`, compare Chrome/Saccade gameplay-layer presence after the same wait, and isolate why the game fails while `selftest-webgl-runtime` is green.

...
3. Canvas/WebGL P1: use `scripts/probe_webgl_game_runtime.py` and `scripts/probe_canvas_reductions.py` as red gates; next refine the 1x threshold around 960-1152 without border/shadow, split solid/gradient/transparent fill behavior, and compare screenshot readback versus live presentation if measurable.

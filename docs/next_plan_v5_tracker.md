...
3. Canvas/WebGL P1: use `scripts/probe_webgl_game_runtime.py` and `scripts/probe_canvas_reductions.py` as red gates; next isolate full-window versus smaller canvas, CSS-sized versus attribute-sized canvas, transform/alpha/background/readback behavior, and WebRender/macOS texture behavior.

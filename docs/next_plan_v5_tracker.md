...
| Browser productization | Official ServoShell adapter gates expanding | `docs/browser_productization_plan.md`; `docs/browser_compat_ledger.md`; `docs/webgl_runtime_probe_report.md`; `docs/servoshell_source_strategy.md`; `docs/servoshell_adapter_migration_plan.md`; `docs/servoshell_adapter_product_gate.md`; `scripts/probe_servoshell_webdriver.py` | Current embedded Saccade browser path is based on crates.io `servo=0.2.0`, while downloaded official Servo.app is ServoShell `0.3.0` and can run the local game. Official ServoShell adapter now passes smoke, safety redaction, screenshot policy, FORMMAX, focused typing, native input/dropdown, same-session login handoff, and local-game reachability gates. Evidence: `runs/servoshell_adapter/adapter_1781626639174/summary.json`; forking official ServoShell source remains fallback for independent trusted UI, in-process ms reflex, and APIs WebDriver cannot safely expose. |

...
| N2 DEVMAX local self-test | Minimal pass | `cargo run -q -p devmax -- selftest-fixtures` | PASS: `total=16 detected=16 false_positives=0`; `engine=static-fixture-v0` |
...
2. Replace DEVMAX static fixture checks with Servo-backed rendered truth for at least 4 fixtures.

...
1. Browser productization P1: add clickable editable URL bar and clickable Back/Forward/Reload/Stop. Title-bar URL/title/loading/nav state, `Cmd+L` keyboard URL entry, and page-click focus recovery are done.

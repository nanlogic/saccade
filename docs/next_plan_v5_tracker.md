...
5. Harden browser-backed MCP sessions: screenshot artifacts from worker, shared multi-tab process, and DEVMAX/FORMMAX integration with the live tab. Worker report/replay and sensitive-value redaction are in place.

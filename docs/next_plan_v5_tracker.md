...
3. WebGL/canvas P1: add scripted runtime selftest for `test_pages/webgl_runtime/index.html`, compare Chrome/Saccade frame count and pixels, and isolate Saccade adapter versus Servo/WebRender/macOS backend.

...
3. Canvas/WebGL P1: use `scripts/probe_webgl_game_runtime.py` as the live-game red/green gate for `http://127.0.0.1:4173/`; next add reductions for full-window Canvas2D, DPR/backing scale, animation timing, DOM HUD over canvas, and WebRender/macOS texture behavior.

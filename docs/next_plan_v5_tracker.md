...
5. Harden browser-backed MCP sessions: screenshots/replay from worker, sensitive-value redaction on arbitrary pages, shared multi-tab process, and DEVMAX/FORMMAX integration with the live tab.

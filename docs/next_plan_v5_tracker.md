...
1. Move Chrome/Firefox visual parity earlier: Chrome CDP capture, Chrome-vs-Saccade compare, Chrome-side click verification, and demo comparison pack exist; next is native Chrome/Safari UI capture after Screen Recording permission and then Firefox capture.

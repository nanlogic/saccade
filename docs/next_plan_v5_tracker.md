...
3. Canvas/WebGL P1: use `scripts/probe_webgl_game_runtime.py` and `scripts/probe_canvas_reductions.py` as red gates; next compare in-page canvas backing/readPixels or checksum against audit screenshot readback for delayed-foreground variants.

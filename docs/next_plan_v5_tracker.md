...
1. Move Chrome/Firefox visual parity earlier: Chrome CDP capture and Chrome-vs-Saccade compare exist; next is root-causing layout differences, then Chrome-side click verification and URL-bar parity artifacts.

...
Active next item: AI-002. AI-001 is blocked by the pinned Servo public API.
...
| AI-002 | P1 | open | Browser shell | Upgrade the toolbar address strip from a hit-zone/status bar to a real URL editing affordance. | User can click the address strip, see edit state clearly in the shell, type a URL, press Enter/Esc, and the toolbar status reports the edit state without page DOM injection. |

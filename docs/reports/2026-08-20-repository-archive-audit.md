...
Status: read-only audit on 2026-08-20. No repository setting was changed.

| Repository | Default branch final SHA | State | Open PRs | Releases | Recent Actions | Packages |
| --- | --- | --- | ---: | --- | --- | --- |
| `nanlogic/cef-saccade` | `803fe341dffd5b6b18eb009301b8d9a61a83a329` | public fork, active | 0 | none | none | public page shows package onboarding/no published package |
| `nanlogic/chromium-saccade` | `24a198fe772b9f4ad2bc8ecfc5331734dccc7f43` | public fork, active | 0 | none | none | public page shows package onboarding/no published package |
...
from the abandoned embedded-browser direction. They can be archived without
affecting the Extension → Native Host → Runtime → MCP product route.
